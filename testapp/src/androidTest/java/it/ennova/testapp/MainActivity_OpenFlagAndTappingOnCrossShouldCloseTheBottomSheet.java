...
public class MainActivity_OpenFlagAndTappingOnCrossShouldCloseTheBottomSheet {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void OpenFlagAndTappingOnCrossShouldCloseTheBottomSheet() {
        ...
        ViewInteraction appCompatImageView = onView(
                allOf(withId(R.id.search_close_btn), withContentDescription("Cancella query"),
